...
$plugin_options = hp_option_page(__('My Plugin Settings', 'hyperpress'), 'my-plugin-settings')
...
$general_section->add_field(
    hp_field('text', 'plugin_title', __('Plugin Title', 'hyperpress'))
        ->set_default(__('My Awesome Plugin', 'hyperpress'))
        ->set_placeholder(__('Enter plugin title...', 'hyperpress'))
);

$general_section->add_field(
    hp_field('textarea', 'plugin_description', __('Plugin Description', 'hyperpress'))
...
$general_section->add_field(
    hp_field('color', 'primary_color', __('Primary Color', 'hyperpress'))
        ->set_default('#007cba')
        ->set_help(__('Choose the primary color for your plugin interface', 'hyperpress'))
);

$general_section->add_field(
    hp_field('image', 'plugin_logo', __('Plugin Logo', 'hyperpress'))
        ->set_help(__('Recommended size: 300x100px', 'hyperpress'))
);

$general_section->add_field(
    hp_field('checkbox', 'enable_feature_x', __('Enable Feature X', 'hyperpress'))
        ->set_default(true)
...
$general_section->add_field(
    hp_field('html', 'api_endpoint', __('API Endpoint', 'hyperpress'))
...
$general_section->add_field(
    hp_field('html', 'custom_script', __('Custom Script Demo', 'hyperpress'))
